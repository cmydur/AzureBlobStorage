...
namespace AzureBlobStorage
{
    public static class AzureBlobContainer
    {
        ...
        public static async Task<string> UploadFileAsync(ContainerType containerType, Stream stream,string extension)
        {
            var container = GetContainer(containerType);
            ...
            fileBlob.Properties.ContentType = $"image/{extension}";
